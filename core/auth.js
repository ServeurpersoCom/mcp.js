...
/**
 * Build the static bearer verifier for one server configuration
 * @param {object} config - Server configuration holding the auth section
 * @returns {{AUTH_ENABLED: boolean, verifyAuthHeader: function}}
 */
function createAuth(config) {
	...
	return { AUTH_ENABLED, verifyAuthHeader };
}
